...
import { BSMGRPLEMAT001 } from '@/services/general/types';
...
type FormData = BSMGRPLEMAT001;

export default function MaterialTypesPage() {
  const router = useRouter();
  const [data, setData] = React.useState<BSMGRPLEMAT001[]>([]);
  const [filteredData, setFilteredData] = useState<BSMGRPLEMAT001[]>([]);
  ...
  // Düzenleme
  function handleEdit(item: BSMGRPLEMAT001) {
  ...
  // Silme
  async function handleDelete(item: BSMGRPLEMAT001) {
