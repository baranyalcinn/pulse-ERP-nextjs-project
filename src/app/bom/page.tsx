  ...
  return (
    <div className="container mx-auto py-6 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <MenuItem
          icon={<FiDatabase />}
          title="Ürün Ağacı Tipleri"
          description="Ürün ağacı tiplerinin tanımları"
          href="/bom/types"
        />
        <MenuItem
          icon={<FiDatabase />}
          title="Ürün Ağacı Ana Bilgileri"
          description="Ürün ağacı ana bilgilerinin yönetimi"
          href="/bom/head"
        />
        <MenuItem
          icon={<FiDatabase />}
          title="Ürün Ağacı İçerikleri"
          description="Ürün ağacı içeriklerinin yönetimi"
          href="/bom/content"
        />
      </div>
    </div>
