...
import { BSMGRPLEWCM001 } from '@/services/general/types';
...
type FormData = BSMGRPLEWCM001;

export default function WorkCenterTypesPage() {
  const router = useRouter();
  const [data, setData] = React.useState<BSMGRPLEWCM001[]>([]);
  const [filteredData, setFilteredData] = useState<BSMGRPLEWCM001[]>([]);
  ...
  // Düzenleme
  function handleEdit(item: BSMGRPLEWCM001) {
  ...
  // Silme
  async function handleDelete(item: BSMGRPLEWCM001) {
