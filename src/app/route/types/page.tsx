...
import { BSMGRPLEROT001 } from '@/services/general/types';
...
type FormData = BSMGRPLEROT001;

export default function RouteTypesPage() {
  const router = useRouter();
  const [data, setData] = React.useState<BSMGRPLEROT001[]>([]);
  const [filteredData, setFilteredData] = useState<BSMGRPLEROT001[]>([]);
  ...
  // Düzenleme
  function handleEdit(item: BSMGRPLEROT001) {
  ...
  // Silme
  async function handleDelete(item: BSMGRPLEROT001) {
